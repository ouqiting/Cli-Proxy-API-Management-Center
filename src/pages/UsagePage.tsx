  ...
  return (
    <div className={styles.container}>
      ...
      <StatCards
        ...
        persistedRpm={persistedRpm}
        persistedTpm={persistedTpm}
        persistedTotalCost={persistedTotalCost}
      />
      ...
      {/* Price Settings */}
      <PriceSettingsCard modelPrices={modelPrices} onPricesChange={setModelPrices} />
    </div>
  );
}
